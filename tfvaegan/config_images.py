...
parser.add_argument('--dataset', type=str,default='FLO', help='FLO')
parser.add_argument('--dataroot', default='/DFGZL/datasets', help='path to dataset')
...
parser.add_argument("--encoder_layer_sizes", type=list, default=[2048, 1024])
parser.add_argument("--decoder_layer_sizes", type=list, default=[1024, 2048])
...
opt.encoder_layer_sizes[1] = opt.ndh
opt.decoder_layer_sizes[-1] = opt.resSize
opt.decoder_layer_sizes[0] = opt.ngh

...
root = "/DFGZL/datasets/"
dataset_dir = os.path.join(root, "caltech-101")
image_dir = os.path.join(dataset_dir, "101_ObjectCategories")
split_path = os.path.join(dataset_dir, "split_Caltech101.json")
...
if os.path.exists(split_path):
    ...
    train, val, test = read_and_split_data(image_dir, ignored=IGNORED, new_cnames=NEW_CNAMES)

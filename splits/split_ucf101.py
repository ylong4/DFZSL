...
def read_data(dataset_dir, image_dir, cname2lab, text_file):
    ...
    with open(text_file, "r") as f:
        ...
        for line in lines:
            ...
            impath = os.path.join(image_dir, renamed_action, filename)
...
root = "/DFGZL/datasets/"
dataset_dir = os.path.join(root, "ucf101")
image_dir = os.path.join(dataset_dir, "UCF-101-midframes")
split_path = os.path.join(dataset_dir, "split_UCF101.json")
...
if os.path.exists(split_path):
    ...
    cname2lab = {}
    filepath = os.path.join(dataset_dir, "ucfTrainTestlist/classInd.txt")
    ...
    trainval = read_data(dataset_dir, image_dir, cname2lab, "ucfTrainTestlist/trainlist01.txt")
    test = read_data(dataset_dir, image_dir, cname2lab, "ucfTrainTestlist/testlist01.txt")

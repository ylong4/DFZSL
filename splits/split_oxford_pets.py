...
def read_data(anno_dir, split_file, image_dir):
...
root = "/DFGZL/datasets/"
dataset_dir = os.path.join(root, "oxford_pets")
image_dir = os.path.join(dataset_dir, "images")
anno_dir = os.path.join(dataset_dir, "annotations")
split_path = os.path.join(dataset_dir, "split_OxfordPets.json")
...
if os.path.exists(split_path):
    ...
    trainval = read_data(anno_dir=anno_dir, split_file="trainval.txt", image_dir=image_dir)
    test = read_data(anno_dir=anno_dir, split_file="test.txt", image_dir=image_dir)
